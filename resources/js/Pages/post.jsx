        ...
        <Layout breadcrumbs={breadcrumbs}>
            <div name="main_block" className='md:col-span-3 sm:col-span-2 mt-5'>
                ...
                <div className='flex justify-end gap-2 max-md:grid grid-cols-1 mb-2'>
                    ...
                    {reply == null && <AddNewCommentButton handleClick={() => { setActiveReply('main_reply'); document.getElementById('main_reply').scrollIntoView() }} />}
                    ...
                    <div className='my-2'>
                        ...
                        <UserContext.Provider value={{ "post_id": post.id }}>
                            {pagination.current_page == 1 && reply == null &&
                                <Comment key={0} routeData={routeData} isPost={true} isMain={true} activeReply={activeReply} setActiveReply={setActiveReply} id={"1"} reply={post}></Comment>
                            }
                            {pagination.current_page == 1 && reply != null &&

                                <Comment key={0} routeData={routeData} isPost={false} isMain={true} activeReply={activeReply} setActiveReply={setActiveReply} id={"1"} reply={reply}></Comment>

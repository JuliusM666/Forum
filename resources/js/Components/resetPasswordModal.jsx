...
export default function ResetPasswordModal({isVisible,setIsShowReset,token}){
    const { data, setData, post, processing, errors,clearErrors,reset } = useForm({
      ...
      function submit(e) {
        ...
        post('/reset-password', {
            preserveScroll: true,
            onSuccess: () =>{ clearErrors(),reset(),setIsShowReset(false)}
            
        })
       }
       return(
        <div style={{visibility: isVisible? "visible":"hidden"}}>
        <Modal> <Card name="Enter your new password" shadow='' ButtonComponent={<CloseButton handleOnClick={()=>setIsShowReset(false)}/>}>

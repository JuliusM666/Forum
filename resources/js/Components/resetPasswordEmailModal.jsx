...
export default function ResetPasswordEmailModal({isVisible,setIsShowEmail}){
    ...
    const { flash } = usePage().props
      ...
      function submit(e) {
       ...
       return(
        ...
        <Modal> <Card name="Enter your Email" shadow='' ButtonComponent={<CloseButton handleOnClick={()=>setIsShowEmail(false)}/>}>

        ...
        <div className="fixed z-10 w-full shadow-slate-300 shadow-inner bg-slate-100 bottom-0" id="modal">
            <div className="flex justify-between p-2 max-md:grid max-md:gap-4 max-md:justify-center">
                ...
                <div className="flex gap-2 max-md:justify-between">
                    <button className="bg-blue-300 rounded-lg p-2 hover:opacity-70 text-slate-100 shadow-sm">I accept cookies</button>
                    <button className="border-slate-700 border rounded-lg p-2 hover:opacity-70 text-slate-700 shadow-sm">I decline cookies</button>
                </div>
            </div>
        </div>
    )

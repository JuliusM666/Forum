...
export default function Comment({ id, routeData, isPost = false, isMain = false, replyLevel = 0, activeReply, setActiveReply, reply }) {
        ...
        <div className="">
            <div className="w-full mt-2 shadow-md">
                ...
                <div className="bg-slate-100 text-slate-700">
                    <div className='p-4 break-all' dangerouslySetInnerHTML={{ __html: reply.message }}></div>

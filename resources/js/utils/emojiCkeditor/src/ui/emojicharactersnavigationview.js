...
import { ViewModel, FormHeaderView, createDropdown, addListToDropdown } from 'ckeditor5';
...
export default class EmojiCharactersNavigationView extends FormHeaderView {
	...
	get currentGroupName() {
		return this.groupDropdownView.value==null ? '😃 Smileys & People' :this.groupDropdownView.value ;
	}
	...
	_createGroupDropdown( groupNames ) {
		...
		dropdown.set( 'value', '😃 Smileys & People' );
